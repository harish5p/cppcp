...
int main(){
    ...
    while(N--){
        ...
        double vol = 3.0* volume(WX,WY,WZ,XY,XZ,YZ);
        double surface_area = area(WX,XY,WY)+area(WX,XZ,WZ)+area(WZ,YZ,WY)+area(XY,YZ,XZ);
        cout << fixed << setprecision(4)<< vol/surface_area <<'\n';
    }
    return 0;
